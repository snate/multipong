...
Fritsch, T., Ritter, H. and Schiller, J.,
\emph{CAN mobile gaming be improved?}.
In Proceedings of 5th ACM SIGCOMM workshop on Network and system support for
games (p. 44). ACM.
October 2006
%%%     bib separator     %%%
\bibitem{bib:study-mobile-phone-sector}
Fritsch, T., Ritter, H. and Schiller, J.,
\emph{User case study and network evolution in the mobile phone sector (a
study on current mobile phone applications)}.
In Proceedings of the 2006 ACM SIGCHI international conference on Advances in
computer entertainment technology (p. 10). ACM.
June 2006
%%%     bib separator     %%%
\bibitem{bib:impact-delay-multi}
Pantel, L. and Wolf, L.C.,
\emph{On the impact of delay on real-time multiplayer games}.
In Proceedings of the 12th international workshop on Network and operating
systems support for digital audio and video (pp. 23-29). ACM.
May 2002
%%%     bib separator     %%%
\bibitem{bib:factors-multi}
Dick, M., Wellnitz, O., and Wolf, L.
\emph{Analysis of factors affecting players' performance and perception in
multiplayer games}.
In Proceedings of 4th ACM SIGCOMM workshop on Network and system support for
games (pp. 1-7). ACM.
October 2005
%%%     bib separator     %%%
\bibitem{bib:survey-mobile-games}
Gerla, M., Maggiorini, D., Palazzi, C.E. and Bujari, A.,
\emph{A survey on interactive games over mobile networks}.
Wireless Communications and Mobile Computing, 13(3), pp.212-229.
2013
\end{thebibliography}
