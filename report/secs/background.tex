...
\texttt{GroupOwnerIntent}, which is a value from 0 (not willing to become the
GO) to 15 (highest inclination to become a Group Owner). If the intents are
equal, then there is also a procedure to execute a tie-break.
