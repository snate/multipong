...
Thanks to the diffusion of smartphones, the mobile games market is becaming each 
...
games must be played using the touch sensor. Moreover, mobile games are usually 
played with smaller screens.
...
There are also different technologies that allow users to play multiplayer mobile 
game such as infrared, Bluetooth, 3G(or newer technologies such as 4G) or Wi-Fi direct. 
