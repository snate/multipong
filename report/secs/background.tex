...
Android doesn't allow to a device to join multiple Wi-Fi Direct groups, but 
the standard permits that. Another problem is that Android devices must ask 
the user for permission to join to a group, and this limits the possibility
to create networks of Wi-Fi Direct devices automatically.
