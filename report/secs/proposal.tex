...
\begin{figure}[h]
    ...
    \caption{Example of communication between a host that is the GO and a participant
     which is a NGO}
...
\begin{figure}[h]
    ...
    \caption{Example of communication between a host that is NGO and two participants,
