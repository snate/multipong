...
\begin{figure}[h]
    ...
    \caption{Example of comunication between a host that is the GO and a participant
     which is a NGO}
...
\begin{figure}[h]
    ...
    \caption{Example of comunication between a host that is NGO and two participants,
     one is the GO, the other one is a NGO}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.30\textwidth]{SequenceDiagram2}
    \caption{Example of comunication between a host and two participants,
     in which \emph{Participant1} has just joined the match and \emph{Participant2}
     not}
    \label{fig:seqDiagram2}
\end{figure}
